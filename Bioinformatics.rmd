...
---
![](D:\Documentos\CUCEI\Delfín\Tools\images\bioinformatics.1.png)
---
...
One of the most important applications of bioinformatics is in the field of genomics. **Genomics** is the study of the genome, which is the complete set of genetic material in an organism.
Bioinformatics tools are used to sequence and assemble genomes as well as to identify and analyse genes and other genomic features.
...
[//]:<> (Revise this to ensure well writing)
...
Bioconductor is a collection of R packages designed and developed by the bioinformatics community. Bioconductor provides a wide range of tools for analysing and visualizing biological data. The
